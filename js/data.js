...
data.tickets = [
    {
        id: 'RPG-0001',
        summary: 'Have a morning cup of coffee and sigarette.',
        type: 'task',
        status: 'todo',
        assignee_id: 'nivato'},
    {
    ...
    {
        id: 'RPG-0004',
        summary: 'Fix base CSS files for Homepage (indentation)!',
        type: 'bug',
        status: 'todo',
    ...
    {
        id: 'RPG-0002',
        summary: 'Fix User Login/Logout backend workflow',
        type: 'bug',
        status: 'review',
